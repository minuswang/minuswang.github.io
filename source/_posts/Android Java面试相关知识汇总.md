---
title: Android Java面试相关知识汇总
date: 2017-10-19 17:00:39
tags: Android Java
---
# Android Java面试相关知识汇总
...
1. 项目中都是用的框架，用过 Servlet 吗？ Servlet 是单例吗？多线程下 Servlet 怎么保证数据安全的？Servlet 的生命周期？
    ...
    - 生命周期
        ...
        1. 回收
1. Thread 状态有哪些
    - ![](https://github.com/c-rainstorm/blog/raw/master/res/java-thread-state.png)
...
1. 垃圾收集器
    - ![gc collectors](https://github.com/c-rainstorm/blog/raw/master/res/gc-collectors.jpg)
    ...
    1. CMS（concurrent mark sweep）并发收集、低停顿
        - ![](https://github.com/c-rainstorm/blog/raw/master/res/jvm-cms-model.png)
    ...
    1. G1
        ...
        - 整体使用标记整理，局部使用复制算法。
        - ![](https://github.com/c-rainstorm/blog/raw/master/res/jvm-g1-model.png)
...
1. 讲讲 Spring 中 ApplicationContext 初始化过程。
    - ApplicationContext 的初始化重点是在 `refresh` 方法，其中最关键的几步是：
        ...
        1. 初始化单例 bean
1. SpringMVC 处理请求的流程
    - ![](https://github.com/c-rainstorm/blog/raw/master/res/springmvc-flow.png)
    1. 收到用户请求
...
1. 数据库事务的四个隔离级别，MySql 在哪一个级别
    - ![](https://github.com/c-rainstorm/blog/raw/master/res/isolation-level.png)
...
1. MySQL 存储引擎有哪些，INNODB 和 MYISAM 的区别
    - ![](https://github.com/c-rainstorm/blog/raw/master/res/mysql-storage-engines-feature-summary.png)
...
1. TCP 和 UDP 的区别
    - ![](https://github.com/c-rainstorm/blog/raw/master/res/diff-tcp-udp.png)
1. TCP 如何保证可靠性
    1. 累计确认
    1. 超时重传
    1. 超时间隔加倍
...
1. OSI七层模型，每层对应的协议有哪些，每层有何含义
    - ![](https://github.com/c-rainstorm/blog/raw/master/res/tcp-ip-model.png)
